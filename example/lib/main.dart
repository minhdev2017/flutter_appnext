import 'package:flutter_appnext/ad/ad_banner.dart';
import 'package:flutter_appnext/ad/ad_interstitial.dart';
import 'package:flutter_appnext/ad/ad_native.dart';
import 'package:flutter_appnext/ad/ad_rewarded.dart';
import 'package:flutter_appnext/appnext_flutter_plugin.dart';
...
class AdsPageState extends State<AdsPage> {
  ...
  void initState() {
    ...
    AppnextFlutterPlugin.init(
      id: "b9f2908b-1a6b-4a5b-b862-ded7ce289e41",
    );
  ...
  void _loadInterstitialAd() {
    AppNextInterstitialAd.loadInterstitialAd(
      placementId:
  ...
  void _loadRewardedVideoAd() {
    AppNextRewardedVideoAd.loadRewardedVideoAd(
      placementId: "473c3af4-03a7-4f66-8630-8a3661918616",
      listener: (result, value) {
  ...
  _showInterstitialAd() {
    if (_isInterstitialAdLoaded == true)
      AppNextInterstitialAd.showInterstitialAd();
    else
  ...
  _showRewardedAd() {
    if (_isRewardedAdLoaded == true)
      AppNextRewardedVideoAd.showRewardedVideoAd();
    else
